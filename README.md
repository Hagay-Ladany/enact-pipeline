...
>[!NOTE]
>In this fork, Sargent was incorporated into the pipline.
> before choosing 'Sargent', the user need to *manually* install the following R packages in the enviroment: data.table, Matrix, Seurat, ggplot2, dplyr, sargent, yaml, rjson.
> [Sargent](https://doi.org/10.1016/j.mex.2023.102196) (doi: https://doi.org/10.1016/j.mex.2023.102196), please contact the paper's corresponding authors for additional information: (nima.nouri@sanofi.com) . We provide the results obtained by Sargent in [ENACT's Zenodo page](https://doi.org/10.5281/zenodo.15211043) under the following folders:
